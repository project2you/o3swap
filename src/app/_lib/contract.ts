...
export const ETH_CROSS_SWAP_CONTRACT_HASH = {
  ETH:
    NETWORK === 'MainNet'
      ...
      : '0x1E7A3e54494F300dC66181621E23eE657E22D725',
  BSC:
    NETWORK === 'MainNet'
      ? '0x3ec481143d688442E581aD7116Bf1ECC76669cfa'
      : '0x6407673152fc40B648C3348BeE66D162d39923c6',
  HECO:
    NETWORK === 'MainNet'
      ? '0x70f4d1176f9276ab4B31658f58F7473858F2b550'
      : '0x5B18542A4cD54C7c1641bdF63541F19072b79260',
};
...
export const POLY_POOL_ADDRESS = {
  ...
  3: '0x5eBdC97947Cb568Dd7feE37a18d576595d61E7c9',
};
...
export const O3STAKING_CONTRACT = {
  ETH: {
    ...
    [LP_TOKENS[1].filter((item) => item.chain === 'ETH')[0].assetID]:
      NETWORK === 'MainNet'
    ...
    [PERP_TOKEN.assetID]: '0xEDdc506Ce6d0344c02fe4fb9126dB50a7C10402d',
  },
  BSC: {},
  HECO: {},
};
